...
import { Aboutpageimg1, Aboutpageimg3, ExecutedImage2, ExecutedImage5 } from '../../assets';
  ...
  return (
    <section className='sub-about-2'>
      <div className="main-about-sub-wrapper-2">
        ...
        <img id='slide-3' src={Aboutpageimg3} alt="Aboutpageimg3" />
        <img id='slide-4' src={ExecutedImage2} alt="Aboutpageimg1" />
